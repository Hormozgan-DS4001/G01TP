...
class CarInfo(Frame):
    def __init__(self, obj_car, tag_list, add_steal, close, refresh_steal):
        ...
        self.close = close
        self.refresh_steal = refresh_steal
        ...
        Label(self, text=f"{self.obj_car.tag[:2]} {self.tag_list[int(self.obj_car.tag[2: 4])]} {self.obj_car.tag[4:]}",
